...
# pkg:gem/crack#lib/crack/xml.rb:196
module Crack; end

# pkg:gem/crack#lib/crack/xml.rb:197
class Crack::REXMLParser
  class << self
    # pkg:gem/crack#lib/crack/xml.rb:198
    def parse(xml); end
  end
end

# pkg:gem/crack#lib/crack/xml.rb:225
class Crack::XML
  class << self
    # pkg:gem/crack#lib/crack/xml.rb:234
    def parse(xml); end

    # pkg:gem/crack#lib/crack/xml.rb:226
    def parser; end

    # pkg:gem/crack#lib/crack/xml.rb:230
...
class REXMLUtilityNode
  ...
  # pkg:gem/crack#lib/crack/xml.rb:73
  def add_node(node); end

  # pkg:gem/crack#lib/crack/xml.rb:24
  def attributes; end
  ...
  # pkg:gem/crack#lib/crack/xml.rb:172
  def inner_html; end
  ...
  # pkg:gem/crack#lib/crack/xml.rb:78
  def to_hash; end
  ...
  # pkg:gem/crack#lib/crack/xml.rb:164
  def undasherize_keys(params); end

  private

  # pkg:gem/crack#lib/crack/xml.rb:191
  def unnormalize_xml_entities(value); end

  class << self
    # pkg:gem/crack#lib/crack/xml.rb:34
    def available_typecasts; end

    # pkg:gem/crack#lib/crack/xml.rb:38
    def available_typecasts=(obj); end

    # pkg:gem/crack#lib/crack/xml.rb:26
    def typecasts; end

    # pkg:gem/crack#lib/crack/xml.rb:30
