...
# Inside docker compose the PSP simulators reach us as `web:3000`, and a
# locally-run simulator as host.docker.internal. Host authorization would
# otherwise 403 every inbound webhook with "Blocked hosts".
Rails.application.configure do
  config.hosts << "web"
